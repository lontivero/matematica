  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_LeftHandSideExpression() {
        ...
        if (result0 !== null) {
          ...
          if (result2 === null) {
            ...
            if (result2 === null) {
              pos1 = pos;
              result2 = parse_OS_BRACKET();
              if (result2 !== null) {
                result3 = parse_LogicalExp();
                if (result3 !== null) {
                  result4 = parse_CS_BRACKET();
                  if (result4 !== null) {
                    result2 = [result2, result3, result4];
                  } else {
                    result2 = null;
      ...
      function parse_ID() {
        ...
        pos0 = pos;
        pos1 = pos;
        if (/^['a'-'z'\/'A'-'Z']/.test(input.charAt(pos))) {
          result0 = input.charAt(pos);
          pos++;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result1 = [];
          if (/^['a'-'z'\/'A'-'Z'\/'0'-'9'\/'_']/.test(input.charAt(pos))) {
            result2 = input.charAt(pos);
            pos++;
          } else {
            result2 = null;
            if (reportFailures === 0) {
              matchFailed("['a'-'z'\\/'A'-'Z'\\/'0'-'9'\\/'_']");
            }
          }
          while (result2 !== null) {
            result1.push(result2);
        ...
        if (result0 !== null) {
          result0 = (function(offset, start, rest) { return { type: 'ID', Name: start + rest.join('') }; })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_SimpleFactorExp() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sign, factor) { 
